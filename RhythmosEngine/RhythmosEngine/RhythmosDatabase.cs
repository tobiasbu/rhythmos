...
{
    /// <summary>
    /// RhythmDatabase Class. Provides a data storage for rhythms and note 
    /// layouts created from the Rhythmos Editor to use in your game.
    /// </summary>
    [Serializable]
    public class RhythmosDatabase
    {
        ...
        [SerializeField]
        private List<Rhythm> m_rhythmDatabase = new List<Rhythm>();

        [SerializeField]
        private List<NoteLayout> m_noteLayoutList = new List<NoteLayout>();
